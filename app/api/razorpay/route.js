...
export const POST=async (req)=>{
    ...
    //checking if razorpayOrderId is present on the server
    ...
    if(x){
        const updatedPayment=await Payment.findOneAndUpdate({oid:body.razorpay_order_id},{$set:{done:true}}, {new:true})
